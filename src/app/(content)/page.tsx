            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  CodeRank.build offers a suite of tools and features to help you track your progress, compete with
                  peers, and showcase your skills to the open-source community.
                </p>
              </div>
            </div>
                ...
                <ul className="grid gap-6">
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className="text-muted-foreground">
                        Easily monitor and manage your open-source contributions, with detailed insights into the issues
                        you've solved.
                      </p>
                    </div>
                  </li>
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className="text-muted-foreground">
                        Compete with other developers and climb the ranks, showcasing your expertise and driving your
                        open-source impact.
                      </p>
                    </div>
                  </li>
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className="text-muted-foreground">
                        Build your online presence and showcase your open-source contributions, projects, and
                        achievements.
                      </p>
                    </div>
                  </li>
          ...
          <div className="container grid items-center gap-6 px-4 md:px-6 lg:grid-cols-2 lg:gap-10">
            <div className="space-y-2">
              ...
              <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                CodeRank.build provides the tools and platform to help you stand out in the open-source community and
                take your contributions to the next level.
              </p>
            </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 border-t">
          <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
            <div className="space-y-3">
              <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">Join the Open-Source Revolution</h2>
              <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Sign up to CodeRank.build and start showcasing your open-source contributions today.
              </p>
            </div>
